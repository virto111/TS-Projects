...
exports.View = void 0; //! <T extends Model<K>, K> -> see this approach, there is no so much logic in it
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      this.bindEvents(templateElement.content); //* Implement nesting
...
},{"./../utils":"node_modules/axios/lib/utils.js","./../core/settle":"node_modules/axios/lib/core/settle.js","./../helpers/cookies":"node_modules/axios/lib/helpers/cookies.js","./../helpers/buildURL":"node_modules/axios/lib/helpers/buildURL.js","../core/buildFullPath":"node_modules/axios/lib/core/buildFullPath.js","./../helpers/parseHeaders":"node_modules/axios/lib/helpers/parseHeaders.js","./../helpers/isURLSameOrigin":"node_modules/axios/lib/helpers/isURLSameOrigin.js","../core/createError":"node_modules/axios/lib/core/createError.js"}],"../../../../Users/viktor/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"../../../../Users/viktor/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
var Eventing = function Eventing() {
  ...
  this.events = {}; //! Below we define bound methods with Arrow Function in order to preserve [this]
...
var Collection = /*#__PURE__*/function () {
  ...
  } //! Short Syntax is not possigble here
...
var Model = /*#__PURE__*/function () {
  function Model(attributes, sync, events) {
    ...
    this.sync = sync;
    this.events = events; //! Below will be shortened
    // get on() {
    //   return this.events.on;
    // }
    // get trigger() {
...
var axios_1 = __importDefault(require("axios")); //* T extends HasId -> Generic Contstaint
...
var Attributes = /*#__PURE__*/function () {
  function Attributes(data) {
    ...
    this.data = data; // get(propName: string): number | string {
...
var attts = new Attributes({
  id: 1,
  name: 'Viktor',
  age: 40
});
var name = attts.get('name');

var printName = function printName(name) {}; // printName('John'); => Must be called with 'stephen'
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    value: function setRandomAge() {
      ...
      console.log('age :: ', age); //? Below is ES2015 syntax
...
users.fetch(); // const root = document.getElementById('root');
...
// });
// collection.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/User":"src/models/User.ts","./models/Collection":"src/models/Collection.ts"}],"../../../../Users/viktor/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Users/viktor/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
